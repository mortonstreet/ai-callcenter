# Plumbing ElevenLabs Capability Map (v1)

Status: Implemented (Spec-Level)
Industry: `plumbing`
Purpose: Trace Plumbing implementation choices to official ElevenLabs documentation.
...
1. Treat production Plumbing agents as private-agent capable.
