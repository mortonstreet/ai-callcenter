# Pest Control ElevenLabs Capability Map (v1)

Status: Implemented (Spec-Level)
Industry: `pest_control`
Purpose: Trace Pest Control implementation choices to official ElevenLabs documentation.
...
1. Treat production Pest Control agents as private-agent capable.
