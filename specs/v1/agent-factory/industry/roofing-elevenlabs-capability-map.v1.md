# Roofing ElevenLabs Capability Map (v1)

Status: Implemented (Spec-Level)
Industry: `roofing`
Purpose: Trace Roofing implementation choices to official ElevenLabs documentation.
...
1. Treat production Roofing agents as private-agent capable.
