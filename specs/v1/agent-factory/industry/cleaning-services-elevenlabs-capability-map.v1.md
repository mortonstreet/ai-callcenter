# Clean Services (Home Cleaning) ElevenLabs Capability Map (v1)

Status: Implemented (Spec-Level)
Industry: `cleaning_services`
Purpose: Trace Clean Services (Home Cleaning) implementation choices to official ElevenLabs documentation.
...
1. Treat production Clean Services (Home Cleaning) agents as private-agent capable.
