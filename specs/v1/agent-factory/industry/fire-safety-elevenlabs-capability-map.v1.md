# Fire Safety ElevenLabs Capability Map (v1)

Status: Implemented (Spec-Level)
Industry: `fire_safety`
Purpose: Trace Fire Safety implementation choices to official ElevenLabs documentation.
...
1. Treat production Fire Safety agents as private-agent capable.
