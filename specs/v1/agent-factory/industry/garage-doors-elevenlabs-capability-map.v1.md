# Garage Doors ElevenLabs Capability Map (v1)

Status: Implemented (Spec-Level)
Industry: `garage_doors`
Purpose: Trace Garage Doors implementation choices to official ElevenLabs documentation.
...
1. Treat production Garage Doors agents as private-agent capable.
