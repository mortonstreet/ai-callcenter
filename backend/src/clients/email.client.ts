                ...
                <tr>
                  <td style="padding: 48px 40px; text-align: center;">
                    ...
                    <table role="presentation" style="margin: 0 auto;">
                      <tr>
                        <td style="background-color: #ff991c; border-radius: 12px;">
                          <a href="${url}" 
                    ...
                    <p style="margin: 32px 0 0 0; font-size: 14px; line-height: 1.5; color: #999;">
                      ...
                      <a href="${url}" style="color: #ff991c; word-break: break-all;">${url}</a>
                    </p>
                  </td>
                </tr>
                <tr>
...
export const sendOrganizationInvitation = async ({
  ...
  await transporter.sendMail({
    from: 'vaci <noreply@vaci.io>',
    to: email,
    subject: `${invitedByUsername} invited you to join ${teamName} on vaci`,
    html: `
      <!DOCTYPE html>
      <html>
      <head>
              ...
              <table role="presentation" style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 12px; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.1);">
                <tr>
                  <td style="padding: 48px 40px; text-align: center;">
                    ...
                    <p style="margin: 0 0 32px 0; font-size: 16px; line-height: 1.6; color: #666;">
                      <strong>${invitedByUsername}</strong> (${invitedByEmail}) has invited you to join the <strong>${teamName}</strong> organization on Vaci.
                    </p>
                    <table role="presentation" style="margin: 0 auto;">
                      <tr>
                        <td style="background-color: #ff991c; border-radius: 12px;">
                    ...
                    <p style="margin: 32px 0 0 0; font-size: 14px; line-height: 1.5; color: #999;">
                      If the button doesn't work, copy and paste this link into your browser:<br>
                      <a href="${inviteLink}" style="color: #ff991c; word-break: break-all;">${inviteLink}</a>
                    </p>
                  </td>
                </tr>
                <tr>
...
export const sendTaskInstanceToDispatcher = async (
  ...
  await transporter.sendMail({
    from: 'vaci <noreply@vaci.io>',
    to: dispatcher.email,
    subject: `New Task Created on Vaci: ${taskInstance.task.name}`,
    html: `
      <!DOCTYPE html>
      <html>
      <head>
            ...
            <td style="padding: 40px 20px;">
              <table role="presentation" style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 12px; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.1);">
                <tr>
                  <td style="padding: 48px 40px; text-align: center;">
                    <h1 style="margin: 0 0 8px 0; font-size: 28px; font-weight: 600; color: #171717; letter-spacing: -0.5px;">
                      New Task Created on Vaci: ${taskInstance.task.name}
                    </h1>
                    <p style="margin: 0 0 32px 0; font-size: 16px; line-height: 1.6; color: #666;">
                      A new task instance has been created for you.
                    </p>
                    <table role="presentation" style="margin: 0 auto;">
                      <tr>
                        <td style="background-color: #ff991c; border-radius: 12px;">
                    ...
                    <p style="margin: 32px 0 0 0; font-size: 14px; line-height: 1.5; color: #999;">
                      If the button doesn't work, copy and paste this link into your browser:<br>
                      <a href="${taskInstanceLink}" style="color: #ff991c; word-break: break-all;">${taskInstanceLink}</a>
                    </p>
                  </td>
                </tr>
              </table>
